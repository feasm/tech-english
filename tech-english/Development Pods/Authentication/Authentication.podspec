...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Felipe Melo/Authentication'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Felipe Melo' => 'feasm159@gmail.com' }
  s.source           = { :git => 'https://github.com/Felipe Melo/Authentication.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '13.0'

  s.source_files = 'Authentication/**/*'
